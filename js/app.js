...
pageSlider.on("activeIndexChange", function () {
  if (this.slides[this.realIndex].classList.contains("screen-aboutcompany")) {
	  $(".number").each(function () {
      $(this)
        .prop("Counter", 0)
        .animate(
...
//========================================================================================================================================================
//ФУНКЦИЯ счетчик цыфр

/*
function outNume(num, element) {
const time = 2000;
  const step = 20;
...
//========================================================================================================================================================
//запуск функции на активном слайде
/*
pageSlider.on("activeIndexChange", function () {
	  if (this.slides[this.realIndex].classList.contains("screen-aboutcompany")) {
		setTimeout(() => outNume(2000, "run-1"), 800);
...
//проверка на количество контента
function setScrollType() {
  ...
  for (let index = 0; index < pageSlider.slides.length; index++) {
    ...
    const pageSlideContent = pageSlide.querySelector("._screen-body");
    if (pageSlideContent) {
...
//========================================================================================================================================================
const differencesSlider = document.querySelector(".screen-differences__body");

let swiperDifferences;

function mobileSlider() {
  if (
    window.innerWidth <= 767.68 &&
    differencesSlider.dataset.mobile == "false"
  ) {
    swiperDifferences = new Swiper(".screen-differences__body", {
      sliderPerView: 1,
      loop: true,
      wrapperClass: "screen-differences__wrapper",
      slideClass: "screen-differences__column",
      observer: true,
      // Обновить свайпер
      // при изменении родительских
      // элементов слайдера
      ...
      observeSlideChildren: true,
      navigation: {
        nextEl: ".screen-differences__rigth",
        prevEl: ".screen-differences__left",
      },
    });
    differencesSlider.dataset.mobile = "true";
  }
  if (window.innerWidth > 767.68) {
    differencesSlider.dataset.mobile = "false";

    if (differencesSlider.classList.contains("swiper-container-initialized")) {
      swiperDifferences.destroy();
    }
  }
}
...
// screen-documens
const documensSlider = new Swiper(".slider-screen-documens", {
  ...
  observeSlideChildren: true,
  navigation: {
    nextEl: ".slider-screen-documens__next",
    prevEl: ".slider-screen-documens__prev",
  },
  pagination: {
    el: ".slider-screen-documens__pagination",
    type: "fraction",
    // Кастомный вывод фракции
    renderFraction: function (currentClass, totalClass) {
      return (
        '<span class="pag-act">0</span><span class="' +
        currentClass +
        '"></span>' +
        '<span class="pag-ne-act">/</span>' +
        '<span class="pag-ne-act">0</span><span class="' +
        totalClass +
        '"></span>'
      );
    },
